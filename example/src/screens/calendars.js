...
const CalendarsScreen = () => {
    ...
    const renderCalendarWithMinAndMaxDates = () => {
        ...
        <Calendar style={styles.calendar} hideExtraDays current={'2012-05-16'} minDate={'2012-05-10'} maxDate={'2012-05-20'}/>
      </Fragment>);
    };
    const renderCalendarWithMarkedDatesAndHiddenArrows = () => {
        return (<Fragment>
        <Text style={styles.text}>Calendar with marked dates and hidden arrows</Text>
        <Calendar style={styles.calendar} current={'2012-05-16'} hideExtraDays disableAllTouchEventsForDisabledDays firstDay={1} markedDates={{
    ...
    const renderCalendarWithMultiDotMarking = () => {
        ...
        <Calendar style={styles.calendar} current={'2012-05-16'} markingType={'multi-dot'} markedDates={{
                '2012-05-08': {
                    selected: true,
                    dots: [
    ...
    const renderCalendarWithPeriodMarkingAndSpinner = () => {
        ...
        current={'2012-05-16'} minDate={'2012-05-10'} displayLoadingIndicator markingType={'period'} theme={{
    ...
    const renderCalendarWithPeriodMarkingAndDotMarking = () => {
        ...
        <Calendar current={'2012-05-16'} minDate={'2012-05-01'} markingType={'period'} markedDates={{
    ...
    const renderCalendarWithMultiPeriodMarking = () => {
        ...
        <Calendar style={styles.calendar} current={'2012-05-16'} markingType={'multi-period'} markedDates={{
                '2012-05-16': {
                    periods: [
    ...
    const renderCalendarWithCustomMarkingType = () => {
        ...
        <Calendar style={styles.calendar} hideExtraDays current={'2018-03-01'} minDate={'2018-03-01'} markingType={'custom'} markedDates={{
                '2018-03-01': {
                    customStyles: {
                        container: {
    ...
    const renderCalendarWithCustomHeader = () => {
        ...
        <Calendar testID={testIDs.calendars.LAST} style={[styles.calendar, styles.customCalendar]} customHeader={CustomHeader}/>
      </Fragment>);
    };
